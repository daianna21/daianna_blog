...
Something evident but worth showing is that the sizes of the "true" libraries we just generated, vary considerably between samples. Specially samples in condition [**A**]{style="color: #FF83FA"} have much larger libraries because of the three genes with high expression.
