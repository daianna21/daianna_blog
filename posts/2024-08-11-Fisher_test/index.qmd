...
This is called a **one-sided Fisher's exact test** since we are evaluating probabilities of extreme values at only one side of the density curve (values $≥a_{11}$=9 for enrichment; see plot below).
