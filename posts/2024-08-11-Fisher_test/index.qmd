...
The **two-sided Fisher’s exact test** considers both tails of the hypergeometric distribution and thus is used when we are interested in both enrichment and depletion, just if there's any association between the variables irrespective of the sign.
